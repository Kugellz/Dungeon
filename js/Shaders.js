        ...
        super({
            ...
            fragShader: `
                ...
                void main(){
                    ...
                    pixelCoord.y += 0.02 *sin(((pixelCoord.x * 90.0) + (uTime* 150.0)) * 0.1); //Add a sin wave using the colour in the x pixel to the y pixel's colour
    ...
    constructor(game){
        super({
            ...
            fragShader: `
                ...
                void main(){
                    vec4 texture = texture2D(uMainSampler, outTexCoord); //Create texture variable, containing colour and alpha values of the pixels
                    vec4 modify = vec4(0.8,0.8,0.8,0.7);
                    gl_FragColor = texture * modify; //Apply the vec4 to the shader. This effectively ends the shader.
                }
            `
        });
    }
